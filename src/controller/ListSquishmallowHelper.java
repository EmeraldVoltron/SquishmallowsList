...
public class ListSquishmallowHelper {
	static EntityManagerFactory emfactory = Persistence.createEntityManagerFactory("SquishmallowsList");
	 ...
	 * @return
	 */
	public List<Squishmallow> searchForSquishBySize(int squishSize) {
